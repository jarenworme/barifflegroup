            ...
            <div className="lp-img-block">
                <div className="lp-img-block-content-wrapper">
                    <p className="lp-text-blue">
                        At Bariffle Group, we believe the Caribbean deserves more than just products — it deserves exceptional quality. 
                        That's why we're committed to supplying regional retailers, grocers, and wholesalers with access to world-class 
                        brands. From premium food and beverages to superior everyday goods, we make quality living more accessible — 
                        all backed by seamless, dependable distribution.
                    </p>
                </div>
            ...
            <div className="lp-img-block lp-reverse-display">
                <div className="lp-img-block-content-wrapper">
                    <p className="lp-text-blue right-align">
                        ...
                        top producers of high-quality goods — delivered with efficiency, reliability, and care.
                    </p>
                </div>
                <div className="lp-img-wrapper">
                ...
                <div className="lp-cards-wrapper">
                    <div className="lp-card">
                        ...
                        <p className="lp-card-text">
                            To become the Caribbean’s most trusted bridge between world-class products and the region's growing demand 
                            for higher-quality everyday choices.
                        </p>
                    </div>
                    <div className="lp-card">
                        ...
                        <p className="lp-card-text">
                            ...
                            brands — supported by seamless, dependable distribution.
                        </p>
                    </div>
                </div>
            </div>
